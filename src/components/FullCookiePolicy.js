...
class FullCookiePolicy extends Component {
    render() {
        return (
            <main><h1>Cookie Policy for Calcul Trainer</h1>
                <p>This is the Cookie Policy for Calcul Trainer, accessible from anatole-sot.xyz/projets/calcultrainer</p>
                ...
                <ul>
                    <li>Email: anatolesot@gmail.com</li>
                </ul>
            </main>
        );
    }
}
export default FullCookiePolicy;